...
Following the incorporation of player feedback from the last event, Following player feedback from the last event, key updates for continuous improvement have been identified:
