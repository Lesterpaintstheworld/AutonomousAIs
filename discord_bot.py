...
async def generate_response(message_content):
    ...
    # For now, we'll use a simple gpt-4o-mini call
...
# Function to generate message using gpt-4o-mini
def generate_gpt4o_message(prompt):
    ...
    for attempt in range(max_attempts):
        try:
            logger.debug(f"Sending gpt-4o-mini request (attempt {attempt + 1})...")
            ...
            logger.debug("Receivedgpt-4o-mini response.")
            ...
            logger.error(f"Error generating gpt-4o-mini message: {str(e)}")
